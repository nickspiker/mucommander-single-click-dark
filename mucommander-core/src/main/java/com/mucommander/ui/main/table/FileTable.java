...
//            return false;
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (source == this && DesktopManager.isLeftMouseButton(e)) {
            // If Command (Mac) or Ctrl (Windows/Linux) is held, let normal selection behavior work
            // This allows Cmd+click or Ctrl+click for multi-select
    ...
    public void mousePressed(MouseEvent e) {
        ...
        // But NOT if Command key is held (we want that for multi-select on Mac)
        if(DesktopManager.isRightMouseButton(e) && !e.isMetaDown()) {
            ...
            // Select clicked row if it is not already part of the selection
        ...
        // Control left-click also works
            ...
            // Command+click or Ctrl+click: Let JTable handle multi-select naturally
            // (We don't need to do anything - just let the default selection behavior work)
        }
    }
